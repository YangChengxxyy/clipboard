...
import com.yycccloud.clipboard.annotation.Secret;
import com.yycccloud.clipboard.entity.ResultVO;
import com.alibaba.fastjson.JSON;
import com.yycccloud.clipboard.utils.AESUtil;
...
public class SecretAOPController {
    ...
    @Pointcut("@within(com.yycccloud.clipboard.annotation.Secret) || @annotation(com.yycccloud.clipboard.annotation.Secret)")
    ...
    public ResultVO around(ProceedingJoinPoint point) {
        ...
        try {
                ...
                for (int i = 0; i < args.length; i++) {
                    ...
                    if (clazz.isInstance(args[i])) {
                        ...
                        if (StringUtils.isNotBlank(encryptStr)) {
                            // 解密
                            String json = AESUtil.decrypt(encryptStr);
                            // 转换vo
            ...
            if (isSecret) {
                ...
                // 加密
                String s = AESUtil.encrypt(jsonString);
                result.setData(s);
            }
